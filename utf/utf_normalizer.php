...
class utf_normalizer
{
	...
	*/
	function nfkc(&$str)
	{
		...
		{
			global $phpbb_root_path, $phpEx;
			include('data/utf_nfkc_qc.php');
		}

		if (!isset($GLOBALS['utf_canonical_comp']))
		{
			global $phpbb_root_path, $phpEx;
			include('data/utf_canonical_comp.php');
		}
	...
	*/
	function nfd(&$str)
	{
		...
		{
			global $phpbb_root_path, $phpEx;
			include('data/utf_canonical_decomp.php');
		}
	...
	*/
	function nfkd(&$str)
	{
		...
		{
			global $phpbb_root_path, $phpEx;
			include('data/utf_compatibility_decomp.php');
		}
	...
	*/
	function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		if (!isset($utf_jamo_index, $utf_jamo_type, $utf_combining_class))
		{
			...
			include('data/utf_normalizer_common.php');
		}
